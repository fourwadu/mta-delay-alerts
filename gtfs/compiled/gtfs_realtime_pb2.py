...
_TRIPUPDATE_STOPTIMEUPDATE_SCHEDULERELATIONSHIP = _TRIPUPDATE_STOPTIMEUPDATE.enum_types_by_name[
...
_TRIPDESCRIPTOR_SCHEDULERELATIONSHIP = _TRIPDESCRIPTOR.enum_types_by_name[
    'ScheduleRelationship']
